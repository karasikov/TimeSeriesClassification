...
for segm_size_idx = 1 : length(segm_size)
    ...
    % MulticlassSVMTuning(X, y, Parameters, {'c', 2.^(-2:5)});
...
accuracy_figure_name = ['NormalDistr_Dataset_USCHAD' ...
...
title('Normal Distribution', 'FontSize', 20, 'FontName', 'Times', 'Interpreter', 'latex');
