...
disp('Perform the same steps using a Sparse ECOCRandom design with a Euclidean Decoding and Nearest Mean Classifier:');
disp('Parameters.coding="ECOCRandom"');
disp('Parameters.decoding="ED"');
disp('Parameters.base="NMC"');

clear Parameters;
Parameters.coding='ECOCRandom';
